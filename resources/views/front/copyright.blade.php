			...
			<div class="content row">
				...
				<div class="row">
					<div class="col-md-8">
                        ...
                        <p>
                            &copy; {{ date('Y') }} NNK Staff Sacco Limited. All rights reserved.  
                            No part of this website, including but not limited to text, graphics, and documents, may be reproduced, distributed, or transmitted in any form or by any means without prior written permission from NNK Staff Sacco. Unauthorized use or duplication of any content is strictly prohibited and may result in legal action.
                        </p>
